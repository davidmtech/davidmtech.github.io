...
var mapczStyle = {
    "constants": {
        ...
        "@prom2rank": {"clamp":[{"add":[{"mul":[ "@prominence", -0.270270 ]}, 14.810810 ]}, 0, 20]},
        ...
        "@town-imp": {"sub":[90,{"mul":[2.5,{"str2num":"$rank"}]}]},
    ...
    "layers": {
        ...
        "towns-labels": {
          ...
          "visibility-switch": [["@z13","towns-labels-z13"], ["@z11","towns-labels-z11"], ["@z9","towns-labels-z9"], ["@z8","towns-labels-z8"], ["@z7","towns-labels-z7"], ["@z6","towns-labels-z6"], ["@z5","towns-labels-z5"]],
        ...
        "towns-labels-z7": {
            "inherit" : "towns-labels-z5",
            "label-source": {"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], {"uppercase":"@city-label"},"@city-label"]}, "@city-label"]},
            "label-size": {"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], 21, {"linear2":["$rank",[[7,19],[18,14]]]} ]}, {"linear2":["$rank",[[7,19],[18,14]]]} ]},
            "label-outline": {"linear2":[{"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], 21, {"linear2":["$rank",[[7,19],[18,14]]]} ]}, {"linear2":["$rank",[[7,19],[18,14]]]} ]},[[14,[0.27,0.75,2.2,2.2]],[50,[0.52,0.75,2.2,2.2]]]]}
        },

        "towns-labels-z8": {
            "inherit" : "towns-labels-z5",
            "label-source": {"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], {"uppercase":"@city-label"},"@city-label"]}, "@city-label"]},
            "label-font": {"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], "@bold-font","@main-font"]}, "@main-font"]},
            "label-size": {"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], 25, {"linear2":["$rank",[[7,21],[18,14]]]} ]}, {"linear2":["$rank",[[7,21],[18,14]]]} ]},
            "label-outline": {"linear2":[{"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], 25, {"linear2":["$rank",[[7,21],[18,14]]]} ]}, {"linear2":["$rank",[[7,21],[18,14]]]} ]},[[14,[0.27,0.75,2.2,2.2]],[50,[0.52,0.75,2.2,2.2]]]]}
        },

        "towns-labels-z9": {
            "inherit" : "towns-labels-z5",
            "label-source": {"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], {"uppercase":"@city-label"},"@city-label"]}, "@city-label"]},
            "label-font": {"if":[["<=","$rank",11],"@bold-font","@main-font"]},
            "label-size": {"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], 30, {"linear2":["$rank",[[7,25],[18,14]]]} ]}, {"linear2":["$rank",[[7,25],[18,14]]]} ]},
            "label-outline": {"linear2":[{"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], 30, {"linear2":["$rank",[[7,25],[18,14]]]} ]}, {"linear2":["$rank",[[7,25],[18,14]]]} ]},[[14,[0.27,0.75,2.2,2.2]],[50,[0.52,0.75,2.2,2.2]]]]}
        },

        "towns-labels-z11": {
            "inherit" : "towns-labels-z5",
            "label-source": {"if":[["<=","$rank",10], {"uppercase":"@city-label"}, "@city-label"]},
            "label-font": {"if":[["<=","$rank",13],"@bold-font","@main-font"]},
            "label-size": {"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], 50, {"linear2":["$rank",[[7,42],[18,14]]]} ]}, {"linear2":["$rank",[[7,42],[18,14]]]} ]},
            "label-outline": {"linear2":[{"if":[["has","$capital"], {"if":[["<=",{"str2num":"$capital"}, 2], 50, {"linear2":["$rank",[[7,42],[18,14]]]} ]}, {"linear2":["$rank",[[7,42],[18,14]]]} ]},[[14,[0.27,0.75,2.2,2.2]],[50,[0.52,0.75,2.2,2.2]]]]}
        },
...
function startDemo() {
    ...
    var params = vtsParseUrlParams();    
       ...
       // params['pos'] =  ['obj', 15.422104, 50.750408, 'fix', 793.53,27.57,-52.27,0.00,5984.35,45.00],
        ...
        params['map'] = 'https://cdn.melown.com/vts/melown2015/test/seznamcz-outdoor-dev/mapConfig.json';
